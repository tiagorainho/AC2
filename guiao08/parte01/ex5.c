...
void test(int baudrate, char parity, unsigned int stopBits, char *string, unsigned int delayTime)
{
    configureUART(baudrate, parity, stopBits);
    puts(string);
    delay(delayTime);
}
...
int main(void)
{
    test(600, 'N', 1, "é lidar irmoum", 250);
    //test(9600, 'E', 1, "é lidar irmoum", 250);
    //test(19200, 'N', 2, "é lidar irmoum", 250);
    //test(115200, 'E', 1, "é lidar irmoum", 250);
